...
In Package.json, use the following script for "dev" if you're on Linux:
...
For windows:
```bash
"dev": "dotenv -e .env.local -- cross-env NODE_OPTIONS=\"--import ./instrument.server.mjs\" vite dev --port 3000",
```
