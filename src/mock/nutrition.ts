...
export const MOCK_CARTE_NUTRITION: CarteRisqueNutrition = {
  ...
  carte: [
    ...
    { region_id: 'MDG-ITM',  region_name: 'Itasy',             score_risque: 0.22, niveau_risque: 'faible',     gam_actuel_pct: 7.1,  tendance: 'falling',  couleur: '#22c55e' },
    { region_id: 'MDG-BMT',  region_name: 'Bongolava',         score_risque: 0.41, niveau_risque: 'moyen',      gam_actuel_pct: 13.2, tendance: 'rising',  couleur: '#eab308' },
    ...
    { region_id: 'MDG-VAT',  region_name: 'Vatovavy',          score_risque: 0.55, niveau_risque: 'élevé',      gam_actuel_pct: 17.8, tendance: 'rising',  couleur: '#f97316' },
    ...
    { region_id: 'MDG-ANO',  region_name: 'Atsimo-Atsinanana', score_risque: 0.62, niveau_risque: 'élevé',      gam_actuel_pct: 19.4, tendance: 'rising',  couleur: '#f97316' },
    ...
    { region_id: 'MDG-ANA2', region_name: 'Analanjirofo',      score_risque: 0.49, niveau_risque: 'moyen',      gam_actuel_pct: 15.6, tendance: 'rising',  couleur: '#eab308' },
    { region_id: 'MDG-ALA',  region_name: 'Alaotra-Mangoro',   score_risque: 0.30, niveau_risque: 'faible',     gam_actuel_pct: 9.5,  tendance: 'falling',  couleur: '#22c55e' },
    ...
    { region_id: 'MDG-MEN',  region_name: 'Melaky',            score_risque: 0.57, niveau_risque: 'élevé',      gam_actuel_pct: 18.2, tendance: 'rising',  couleur: '#f97316' },
    ...
    { region_id: 'MDG-DIA',  region_name: 'Diana',             score_risque: 0.26, niveau_risque: 'faible',     gam_actuel_pct: 8.4,  tendance: 'falling',  couleur: '#22c55e' },
    ...
    { region_id: 'MDG-IHO',  region_name: 'Ihorombe',          score_risque: 0.72, niveau_risque: 'très élevé', gam_actuel_pct: 22.8, tendance: 'rising',  couleur: '#ef4444' },
    { region_id: 'MDG-ASO',  region_name: 'Atsimo-Andrefana',  score_risque: 0.78, niveau_risque: 'très élevé', gam_actuel_pct: 25.6, tendance: 'rising',  couleur: '#ef4444' },
    { region_id: 'MDG_AND',  region_name: 'Androy',            score_risque: 0.82, niveau_risque: 'très élevé', gam_actuel_pct: 28.1, tendance: 'rising',  couleur: '#ef4444' },
...
export const MOCK_NUTRITION_ALERTS: AlerteNutrition[] = [
  { alerte_id: 'NUT-001', region_id: 'MDG_AND', region_name: 'Androy', type_alerte: 'crise_nutritionnelle', severite: 'crise', statut: 'active', date_detection: dPast(7), description: 'GAM 28.1% — humanitarian crisis threshold (>20%) exceeded. Urgent RUTF intervention required.', indicateur: 'gam_pct', valeur: 28.1, seuil: 20.0 },
  { alerte_id: 'NUT-002', region_id: 'MDG-ASO', region_name: 'Atsimo-Andrefana', type_alerte: 'crise_nutritionnelle', severite: 'urgence', statut: 'active', date_detection: dPast(4), description: 'GAM 25.6% in continuous rise — prolonged drought impacting food availability.', indicateur: 'gam_pct', valeur: 25.6, seuil: 20.0 },
  { alerte_id: 'NUT-003', region_id: 'MDG-IHO', region_name: 'Ihorombe', type_alerte: 'seuil_urgence', severite: 'alerte', statut: 'active', date_detection: dPast(10), description: 'GAM 22.8% — enhanced surveillance, RUTF stocks to be replenished.', indicateur: 'gam_pct', valeur: 22.8, seuil: 20.0 },
]
...
export const MOCK_RECIPES: RecetteNutritionnelle[] = [
  ...
  },
  {
    ...
    instructions: 'Sauté the onions. Add the spinach and stir-fry for 5 min. Mix in the crushed peanuts. Season and serve.',
  },
  {
    ...
    instructions: 'Soak the beans for 8h. Cook for 45 min. Prepare the tomato-ginger sauce. Combine and simmer for 10 min.',
  },
]
