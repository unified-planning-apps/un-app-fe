...
export const DEMO_USERS_LIST: UserResponse[] = [
  DEMO_USER,
  { user_id: 2, username: 'admin', email: 'admin@healthshield.mg', full_name: 'Administrator', role: 'admin', region_id: null, organisation: 'Ministère de la Santé', is_active: true },
